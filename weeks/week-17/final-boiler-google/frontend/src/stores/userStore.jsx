...
export const userStore = create((set, get) => ({
  ...
  // Function to Handle Google Login+Registration
  handleGoogleLogin: () => {
    window.location.href = `${apiEnv}/auth/google`;
  },
  // Function to Handle Google Login+Registration REDIRECTION SUCCESS ROUTE
  handleGoogleLoginSuccess: (accessToken, username) => {
    ...
    // Store the username in the browser's localStorage.
