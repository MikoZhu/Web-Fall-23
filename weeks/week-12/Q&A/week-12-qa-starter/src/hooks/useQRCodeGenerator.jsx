  ...
  const generateQRCode = () => {
    ...
    QRCode.toDataURL(
      ...
      url,
      {
        ...
        margin: 2, // set the margin for the qr code
        color: {
          dark: "#335383FF", // sets the color of the darkSquares  (blotteredSquares)
          light: "#EEEEEEFF", //  sets the color of the light squares (backPart)
        },
      },
  ...
  const downloadQRCode = () => {
    ...
    const getFileName = () => {
      ...
      const fileName = prompt(
        "Please enter a name for your QR Code to  be downloaded"
      );
