...
export const QuestionDistributive = () => {
  const questions = [
    {
      id: 0,
      title: "Can you clarify the concept of 'key' in React for me?",
      context:
        "Questions are centered around understanding the concept of keys in React, their necessity, their usage, and their flexibility in terms of what can be used as a key. ",
    },
    {
      id: 1,
      title:
        "What are there spaces in the jsx like for instance closing tags < /> and between some curly brackets like { name }? Is there a simple way to know when to add the space?",
      context:
        "Understanding the usage and significance of spaces within JSX syntax in a React context, specifically within self-closing tags and curly brackets.",
    },
    {
      id: 2,
      title:
