...
export const LottieAdvancedComponent = () => {
  const options = {
    lottieRef: useRef(), // IMPORTANT THIS HOOK WILL BE EXPLAINED NEXT WEEK // IN SIMMPLER TERMS WE USE THIS HOOK TO REFERENCE AN ELEMENT WITHIN THE RETURN STATEMENT :)
